...
export const departmentProfiles: DepartmentProfile[] = [
  ...
  {
    key: 'thoracic_surgery',
    label: '흉부외과',
    matchers: [/흉부외과|흉부\s*외과|심장외과|심혈관외과|흉강경/i],
    allowedContext: /폐|심장|흉부|흉강|심혈관|대동맥|판막|폐암|흉부\s*수술|심장\s*수술|식도/,
    forbiddenContext: /산후|분만|산모|제왕절개|부인과|IBD|크론|궤양성\s*대장염|위장관\s*출혈|대장암|직장암|췌장|담낭|간\s*절제|간절제|위암|위\s*절제|뇌수술|척추수술/,
    fallback: fallbackSet({
      winuf: [
        '흉부외과 수술 후 식이 진행이 늦어 정맥영양이 필요한 회복기 환자',
        '위너프에이플러스의 흉부외과 수술 후 단백 보충과 회복기 영양',
        '흉부외과 수술 후 회복기 환자의 식사량과 영양 공급 반응 확인',
        '위너프에이플러스 단백 보충을 흉부외과 수술 후 식이 진행이 늦은 환자 상황에 맞춰 말씀드림. 교수님께서 심장·폐 수술 후 회복기 영양은 환자 상태에 맞춰 보겠다는 반응 보임',
        '다음방문시에는 흉부외과 수술 후 회복기 환자의 식사량과 영양 공급 반응 확인할예정',
      ],
      ferinject: [
        '심장·폐 수술 전후 Hb 교정이 필요한 빈혈 환자',
        '페린젝트의 흉부외과 수술 전후 빈혈 교정과 수혈 부담 감소',
        '심장·폐 수술 전후 빈혈 환자의 Hb 추이 확인',
        '페린젝트 1회 투여를 심장·폐 수술 전후 Hb 교정이 필요한 환자 상황에 맞춰 말씀드림. 교수님께서 흉부외과 수술 전후 빈혈 교정은 필요한 케이스부터 보겠다는 반응 보임',
        '다음방문시에는 심장·폐 수술 전후 빈혈 환자의 Hb 추이 확인할예정',
      ],
    }),
  },
  {
