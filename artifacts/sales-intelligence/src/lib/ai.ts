...
★ 절대 규칙: 반응근거 + 다음방문계획을 합쳐서 반드시 250자(한글 기준) 이내로 작성할 것. 250자를 초과하면 안 됨.
...
===영업일지===
(실제 방문한 것처럼 작성한 일지. 앞부분에 반응근거, 뒷부분에 다음방문계획을 자연스럽게 이어서 작성. 빈 줄 없이 바로 다음 줄에 이어서 쓸 것. 별도 제목이나 구분선 붙이지 말 것. 반드시 250자 이내)`;
